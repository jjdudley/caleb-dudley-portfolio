    ...
    value: function render() {
      ...
      var addImage = function addImage(srcType, imageClass, transforms) {
        ...
        if (discourageDownloads) {
          ...
          images.push(React__default['default'].createElement("img", _extends$1({}, imageCrossOrigin ? {
      ...
      return React__default['default'].createElement(Modal, _extends$1({
        isOpen: true,
...
var Row = styled__default['default'].div(_templateObject());
...
var Col = styled__default['default'].div(_templateObject$1(), function (props) {
...
Col.propTypes = {
  ...
  md: PropTypes__default['default'].number.isRequired
};
...
var ImgWrapper = styled__default['default'].div(_templateObject$2(), function (props) {
  return props.margin;
});
...
var Gallery = function Gallery(_ref) {
  ...
  var thumbsArray, fullArray, thumbAltArray; // New style with all images in one prop

  thumbsArray = images.filter(function (thumb) {
    return thumb !== undefined;
  }).map(function (_ref2) {
    var thumb = _ref2.thumb;
    return thumb;
  });
  thumbAltArray = images.map(function (_ref3) {
    var thumbAlt = _ref3.thumbAlt;
    return thumbAlt;
  });
  fullArray = images.filter(function (image) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(Row, null, thumbsArray.map(function (thumbnail, thumbIndex) {
    ...
    }, /*#__PURE__*/React__default['default'].createElement(ImgWrapper, {
      margin: gutter
    }, /*#__PURE__*/React__default['default'].createElement(Img__default['default'], {
      fluid: thumbnail,
      className: imgClass,
      alt: thumbAltArray ? thumbAltArray[thumbIndex] ? thumbAltArray[thumbIndex] : '' : ''
    })));
  })), isOpen && /*#__PURE__*/React__default['default'].createElement(ReactImageLightbox, _extends({
...
Gallery.propTypes = {
  images: PropTypes__default['default'].arrayOf(PropTypes__default['default'].shape({
    full: PropTypes__default['default'].object,
    thumb: PropTypes__default['default'].object,
    thumbAlt: PropTypes__default['default'].string,
    title: PropTypes__default['default'].node,
    caption: PropTypes__default['default'].node
  })),
  colWidth: PropTypes__default['default'].number,
  mdColWidth: PropTypes__default['default'].number,
  gutter: PropTypes__default['default'].string,
  imgClass: PropTypes__default['default'].string,
  lightboxOptions: PropTypes__default['default'].object
};
